...
<script type="text/javascript" src="/thinkphp_3.2.2_full/Public/js/custom/index.js"></script>
<!--[if IE 9]>
	...
	<div class="loginbox">
    	<div class="loginboxinner">
            ...
            <div class="nopassword">
				<div class="loginmsg">密码不正确.</div>
                <div class="loginf">
                    <div class="thumb"><img alt="" src="/thinkphp_3.2.2_full/Public/images/thumbs/avatar1.png" /></div>
