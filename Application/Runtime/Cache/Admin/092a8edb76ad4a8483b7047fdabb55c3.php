            ...
            <form class="stdform" method="get" action="<?php echo U('Admin/student/index');?>">
                <div class="tableoptions">
                    ...
                    <div style='float:right;margin-right:500px;margin-top:-4px;'>
                        <label>
                            <input type='text' name='search' placeholder='学号/姓名' value='<?php echo ($_GET['search']); ?>' />
                        </label>
                ...
                <?php if(is_array($students)): foreach($students as $key=>$data): ?><tr>
                        <td align="center"><input type="checkbox" /></td>
                            ...
                            <td calss='center'>
                               ...
                               <a href="<?php echo U('Admin/Student/delete',array('id'=>$data['id']));?>" class="btn btn_trash"><span>删除</span></a>
...
<script type="text/javascript">
    var ajax_school = $('#school_ajax').change(function(){
        var id = $(this).val();
        if(id != '0'){
            ...
            html2 = "<option value='0'>请选择班期</option>";
            $('#class_name').empty();
            $('#class_name').append(html2);
        }
    });
</script>
